...
SRC_URI += "git://git@github.com/balena-os/os-config.git;protocol=ssh;branch=rust-1.31.1"
SRCREV = "ffccdf429feb5923c26db14d23743fb78aa7308f"
S = "${WORKDIR}/git"
CARGO_SRC_DIR=""
PV_append = ".AUTOINC+ffccdf429f"
